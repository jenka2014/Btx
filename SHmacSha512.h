...
static void sha512_update(sha512_ctx * ctx, const unsigned char *message, unsigned int len)
{
...
static void sha512(const unsigned char *message, unsigned int len, unsigned char *digest) {
	sha512_ctx ctx;
	sha512_init(&ctx);
...
static void hmac_sha512_update(hmac_sha512_ctx * ctx, const unsigned char *message, unsigned int message_len)
{
...
{
	unsigned char digest_inside[SHA512_DIGEST_SIZE], mac_temp[SHA512_DIGEST_SIZE];
...
char *hmac_sha512_str(const char *key, unsigned int key_size, const char *message) {
	...
	hmac_sha512((const unsigned char *)key, key_size, (const unsigned char *)message, strlen(message), mac, SHA512_DIGEST_SIZE);
